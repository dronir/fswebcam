...
#define SRC_PAL_VYUY    (10)
#define SRC_PAL_YUV420P (11)
#define SRC_PAL_NV12MB  (12)
#define SRC_PAL_BAYER   (13)
#define SRC_PAL_SBGGR8  (14)
#define SRC_PAL_SRGGB8  (15)
#define SRC_PAL_SGBRG8  (16)
#define SRC_PAL_SGRBG8  (17)
#define SRC_PAL_RGB565  (18)
#define SRC_PAL_RGB555  (19)
#define SRC_PAL_Y16     (20)
#define SRC_PAL_GREY    (21)
#define SRC_PAL_HAX         (22)
